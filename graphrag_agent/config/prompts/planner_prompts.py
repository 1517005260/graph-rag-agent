...
**可用任务类型**:
1. **local_search**: 在知识图谱的特定社区内进行精确检索，适合查询具体实体和细节
2. **global_search**: 跨社区的全局摘要检索，适合理解整体概念和宏观信息
3. **deep_research**: 深度研究和多轮推理，适合需要复杂思考和证据链追踪的问题
4. **chain_exploration**: 图谱路径探索，通过实体关系链追踪信息，适合"如何达成"类问题
